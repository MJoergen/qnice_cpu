...
% right, and the dotted boundary of the CPU_MAIN entity. It does NOT show the
% valid/ready handshaking, the redirect paths from WRITE and DECODE back to
% FETCH, or the bank-switch signals -- those are described in doc/README.md
% and in the per-module READMEs, and drawing them here would turn the picture
% into a net list.
