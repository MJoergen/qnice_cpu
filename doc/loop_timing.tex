...
% down: ICACHE/m_valid_o + m_addr_o, DECODE/prep_valid_o + prep_stage_o.addr,
% and WRITE/prep_valid_i + prep_stage_i.addr. A low line means the stage is
% empty in that cycle.
%
% WRITE/prep_stage_i.microcodes is 36 bits wide -- the whole list of up to three
% micro-operations -- but only the low 12 bits, the one being executed, are
% shown. 0x084 is MEM_READ_SRC + REG_MOD_SRC, 0x828 is LAST + MEM_WAIT_SRC +
% REG_WRITE, and 0x808 is LAST + REG_WRITE.
...
\begin{wave}{29}{11}
 ...
 \nextwave{FETCH/dc\_data\_o}             \unknown[x]{2} \cmove{0048}{1} \cand{9F88}{1} \cand{0002}{1} \crbra{FFA3}{2} \crbra{FFFB}{1} \unknown[0000]{2} \unknown[x]{1}
 ...
 \nextwave{DECODE/prep\_valid\_o}         \bit{1}{1} \bit{0}{3} \bit{1}{4} \bit{0}{1} \bit{1}{2}
 \nextwave{DECODE/prep\_ready\_i}         \bit{1}{4} \bit{0}{2} \bit{1}{5}
 \nextwave{DECODE/prep\_stage\_o.addr}    \unknown[000A]{1} \unknown[x]{3} \cmove{0005}{3} \cand{0006}{1} \unknown[x]{1} \crbra{0008}{1} \unknown[000A]{1}
 ...
 \nextwave{WRITE/prep\_stage\_i.microcodes} \crbra{808}{1} \unknown[x]{4} \cmove{084}{1} \unknown[x]{1} \cmove{828}{1} \cand{808}{1} \unknown[x]{1} \crbra{808}{1}
 \nextwave{WRITE/mem\_req\_valid\_o}      \bit{0}{5} \bit{1}{1} \bit{0}{5}
 \nextwave{WRITE/mem\_req\_addr\_o}       \unknown[x]{5} \cmove{000A}{1} \unknown[x]{5}
 \nextwave{MEMORY/msrc\_valid\_o}         \bit{0}{6} \bit{1}{1} \bit{0}{4}
 \nextwave{MEMORY/msrc\_data\_o}          \unknown[x]{6} \cmove{0000}{1} \unknown[x]{4}
 ...
 \nextwave{REGISTERS/wr\_val\_i}          \crbra{0005}{1} \unknown[x]{6} \cmove{0000}{1} \cand{0000}{1} \unknown[x]{1} \crbra{0005}{1}
