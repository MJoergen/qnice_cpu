...
% empty in that cycle.
%
% WRITE/prep_stage_i.microcode is the single 12-bit micro-operation the
% SEQUENCER selected out of DECODE's list, i.e. the one being executed. 0x084 is
...
\begin{wave}{29}{11}
 ...
 \nextwave{WRITE/prep\_stage\_i.microcode}  \crbra{808}{1} \unknown[x]{4} \cmove{084}{1} \unknown[x]{1} \cmove{828}{1} \cand{808}{1} \unknown[x]{1} \crbra{808}{1}
